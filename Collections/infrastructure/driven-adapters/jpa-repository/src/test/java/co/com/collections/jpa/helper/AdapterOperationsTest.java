package co.com.collections.jpa.helper;

import co.com.collections.jpa.PickupRequestRepository;
import co.com.collections.jpa.PickupRequestRepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    private PickupRequestRepositoryAdapter adapter;
    ...
    void setUp() {
        ...
        adapter = new PickupRequestRepositoryAdapter(repository, objectMapper);
    }
